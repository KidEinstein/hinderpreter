/**
 * \mainpage hinderpreter Documentation
 *
 ...
 * \section about About
 *
 * hinderpreter is a हिंदीआ interpreter written in C and is designed to be correct,
 * portable, fast, and precisely documented.
 *
 *   - correct: Every effort has been made to test hinderpreter's conformance to the
 *   हिंदीआ language specification. Unit tests come packaged with the hinderpreter
 *   source code.
 *
 *   - portable: hinderpreter follows the widely ported ANSI C specification allowing it
 ...
 *
 *   - precisely documented: hinderpreter uses Doxygen to generate literate code
 *   documentation, browsable here.
 *
 * \section organization Organization
 *
 * hinderpreter employs several different modules which each perform a specific task
